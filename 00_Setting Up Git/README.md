...
```
origin  git@github.com:chris-alexiuk/AIE7.git (fetch)
origin  git@github.com:chris-alexiuk/AIE7.git (push)
upstream        git@github.com:AI-Maker-Space/AIE7.git (fetch)
upstream        git@github.com:AI-Maker-Space/AIE7.git (push)
```
